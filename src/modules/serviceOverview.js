  ...
  details: [
    {
      ...
      points: [
        '기획 의도: 저는 챗챗이 제시한 조직의 문제와 창립 과정의 약속을 모바일에서 풀어내고자 했습니다. 리버가 제 기획을 검토하며 제시한 확장 의견을 함께 논의하고, 앱에서 쉽고 편하게 사용할 수 있는 경험으로 다듬었습니다.',
      ...
      questions: [
        ...
        '핵심 기능의 목적과 역할을 유지하면서 먼저 개선할 사용 흐름은 무엇인가요?',
      ],
    },
    {
      body: '공지, 일정, 출석, 스터디가 흩어져 있으면 챌린저는 활동을 놓치기 쉽고 운영진은 확인과 후속 조치에 시간을 쓰게 됩니다. 저는 이런 운영 문제를 풀기 위해 필요한 정보와 행동을 한 앱에서 이어갈 수 있도록 기획했습니다.',
      points: [
